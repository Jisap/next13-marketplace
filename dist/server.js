...
var next_utils_1 = require("./app/next-utils");
...
var app = (0, express_1.default)(); // Instancia de Express
var PORT = Number(process.env.PORT) || 3000; // Puerto donde trabaja
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                app.post("/api/webhooks/stripe", webhookMiddleware, webhooks_1.stripeWebhookHandler); // Petición a stripe pasando al stripeWebhookHandler el cuerpo sin procesar de la solictud
            ...
            case 1:
                ...
                cartRouter.get("/", function (req, res) {
                    var request = req;
                    if (!request.user)
                        return res.redirect('sign-in?origin=cart'); // Si el usuario no está autenticado, redirecciona a la página de inicio de sesión con un parámetro de origen (origin=cart).
                    var parsedUrl = (0, url_1.parse)(req.url, true); // Analiza la URL y extraer los parámetros de la consulta 
                    return next_utils_1.nextApp.render(req, res, "/cart", parsedUrl.query); // Renderizar la página del carrito usando Next.js 
                });
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    // @ts-expect-error
                                    return [4 /*yield*/, (0, build_1.default)(path_1.default.join(__dirname, '../'))]; // Ejecutar la construcción de Next.js
                                case 1:
                                    // @ts-expect-error
                                    _a.sent(); // Ejecutar la construcción de Next.js
                ...
                app.use('/api/trpc', trpcExpress.createExpressMiddleware({
                    router: trpc_1.appRouter, // appRouter que es el router de trpc y sus procedimientos
                    createContext: createContext // basados en la gestión de las req/res que da el contexto
                }));
                app.use(function (req, res) { return (0, next_utils_1.nextHandler)(req, res); }); // Se le indica a express que use el manejador de solicitudes http de next.js
