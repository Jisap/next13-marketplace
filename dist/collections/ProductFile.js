            ...
            switch (_b.label) {
                case 0:
                    ...
                    if ((user === null || user === void 0 ? void 0 : user.role) === "admin")
                        return [2 /*return*/, true]; // Si el usuario es admin puede ver todos 
                    if (!user)
                        return [2 /*return*/, false]; // Sino existe un usuario no puede ver nada
                ...
                case 1:
                    ...
                    ownProductFileIds = products // De los ptos existentes se obtienen los productos que el usuario a creado y de los que es propietario
                ...
                case 2:
                    ...
                    purchasedProductFileIds = orders.map(function (order) {
                        return order.products.map(function (product) {
                            if (typeof product === "string")
                                return req.payload.logger.error(// Si el product es una cadena, el pto es solo un id y no se ha recuperado completamente
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFileIds, true), purchasedProductFileIds, true) // El usuario tendrá acceso a los ptos cuyas ids sean de sus creaciones y de lo que haya comprado
                            }
                        }];
            }
        });
