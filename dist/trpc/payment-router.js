...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure // La creación de una session de pagos requiere autenticación (privateProcedure)
        .input(zod_1.z.object({ productIds: zod_1.z.array(zod_1.z.string()) })) // Recibe un objeto con un array de Ids de productos (productsIds) validado por zod
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        user = ctx // Del ctx obtenemos el user
                        .user;
                        productIds = input // del input los productIds como array
                        .productIds;
                        if (productIds.length === 0) {
                            throw new server_1.TRPCError({ code: 'BAD_REQUEST' }); // Sino hay ptos en la lista lanzamos el error.
                        }
                    ...
                    case 3:
                        order = _b.sent();
                        line_items = [] // objetos tipo "Stripe.Checkout.SessionCreateParams.LineItem"
                        ;
    ...
    pollOrderStatus: trpc_1.privateProcedure // Este procedimiento 
